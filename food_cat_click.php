            ...
            <div class="content">
              ...
              -->
                    ...
                    <?php
                        ...
                        if(isset($_GET['food_cat_id'])){
                         ...
                         $show_food="select * from food_table where food_category='$food_cat_id' limit $page1,3";
              ...
              -->
                    ...
                    <td colspan="3">
                        ...
                        $check="select * from food_table where food_category='$food_cat_id'";
                        ...
                        for($b=1;$b<=$a;$b++)
                        {
                            ?><a href="food_cat_click.php?page=<?php echo $b; ?>" style="text-decoration:none;"><?php echo $b." "; ?></a><?php
                        }
