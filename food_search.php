         ...
         <div class="content_area">
            ...
            <div class="content">
                  <form action="food_search.php" post="get" enctype="multipart/form-data">
                    <input class="search inputdata" type="search" name="search_query" placeholder="Searching Your Favourite Restaurants"/>
              ...
              -->
                    ...
                    <?php
                        ...
                        if(!isset($_GET['food_cat_id'])){
                         $show_food="select * from food_table where food_keywords like '%$search_query%' limit $page1,3";
              ...
              -->
                     ...
                     <?php       
                            ...
                            $show_cat_food="select * from food_table where food_category='$food_cat_id'";
                            $run_cat_food=mysqli_query($con,$show_cat_food);
                            while($row_cat_food=mysqli_fetch_assoc($run_cat_food))
                            {
                                $food_id=$row_cat_food['food_id'];
                                $food_name=$row_cat_food['food_name'];
                                $food_title=$row_cat_food['food_title'];
                                $food_category=$row_cat_food['food_category'];
                                $food_price=$row_cat_food['food_price'];
                                $food_restaurant=$row_cat_food['food_restaurant'];
                                $food_image=$row_cat_food['food_image'];
                                $food_details=$row_cat_food['food_details'];
                    ...
                    <tr>
                         ...
                         <!-- ---------------
                    ----------   SHOW FOOD FROM DATABASE END CATEGORY  FOOD SHOW --------------
                    ------------------------
              -->
              ...
              -->
                ...
                <!-- ---------------
                    ----------   pagination area most important --------------
                    ------------------------
              -->
